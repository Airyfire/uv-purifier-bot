...
| # | Question | Status |
|---|----------|--------|
| 1 | Does a stationary HEPA purifier clean stagnant zones effectively? | No, different zones in a room have different PM2.5 readings varying by 5-10 μg/m³|
| 2 | Does a moving purifier outperform stationary in overall room cleaning? | ⬜ Planned |
